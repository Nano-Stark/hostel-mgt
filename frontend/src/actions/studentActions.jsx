...
export const addStudent = (student) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axiosInstance.post(`/student/addStudent`, student, config);
...
export const getStudentDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axiosInstance.get(`/student/${id}`, config);
...
export const deleteStudent = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axiosInstance.delete(`/student/${id}`, config);
...
export const getStudentsByRoomNo = (roomNo) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axiosInstance.get(`/student/room/${roomNo}`, config);
    dispatch({
